...
function RTCPeerConnection() {
  ...
  this.setConfiguration = function setConfiguration(configuration) {
    return pc.setConfiguration(configuration);
  };
...
// NOTE(mroberts): We don't use this anymore, but simple-peer still uses this to
// identify node-webrtc.
