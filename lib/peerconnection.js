...
function RTCPeerConnection() {
  ...
  pc.onicecandidate = function onicecandidate(candidate) {
    ...
    self.dispatchEvent(new RTCPeerConnectionIceEvent('icecandidate', { candidate: icecandidate, srcElement: self.getSrcElement() }));
  };
  ...
  pc.onsignalingstatechange = function onsignalingstatechange() {
    self.dispatchEvent({ type: 'signalingstatechange', srcElement: self.getSrcElement() });
  };

  pc.oniceconnectionstatechange = function oniceconnectionstatechange() {
    self.dispatchEvent({ type: 'iceconnectionstatechange', srcElement: self.getSrcElement() });
  };

  pc.onicegatheringstatechange = function onicegatheringstatechange() {
    self.dispatchEvent({ type: 'icegatheringstatechange', srcElement: self.getSrcElement() });
  ...
  pc.onnegotiationneeded = function onnegotiationneeded() {
    self.dispatchEvent({ type: 'negotiationneeded', srcElement: self.getSrcElement() });
  };
