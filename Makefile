...
prepare_env:
	...
	mkdir -p third_party/libwebrtc; cd third_party/libwebrtc; ../../tools/depot_tools/gclient config http://webrtc.googlecode.com/svn/trunk/; ../../tools/depot_tools/gclient sync --force --revision r4999

build_deps:
	cd third_party/libwebrtc/trunk; ninja -C out/Release peerconnection_client
